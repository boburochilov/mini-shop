...
/** @var app\models\NewArrivalsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'New Arrivals';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="new-arrivals-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Create New Arrivals', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
...
//            'id',
                    ...
                    [
                        'attribute' => 'image',
                        'value' => function($data){
                            $image = \app\components\StaticFunctions::getImage('new-arrivals',$data->id,$data->image);
