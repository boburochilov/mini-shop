...
/** @var app\models\BannerCategoriesSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Banner Categories';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="banner-categories-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Banner Category', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
