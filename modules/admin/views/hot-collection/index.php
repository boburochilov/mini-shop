...
/** @var app\models\HotCollectionSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Hot Collections';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="hot-collection-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Create Hot Collection', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
