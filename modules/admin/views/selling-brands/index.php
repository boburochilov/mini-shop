...
/** @var app\models\SellingBrandsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Selling Brands';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="selling-brands-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Create Selling Brands', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
