...
<section class="page-title-area">
    <div class="container">
        <div class="page-title-content">
            <h1>Каталог товаров - <span style="text-transform: uppercase;"><?=$productCategory->name?></span></h1>
            <ul>
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <?php else:?>
                    ...
                    <div class="no_photo text-center">
                        <h1 class="text">
                            В категории <a href="" class="text-primary"><?=$productCategory->name?></a> пока нет товаров (
