...
<section class="page-title-area">
    <div class="container">
        <div class="page-title-content">
            <h1>Бренд продукта - <span style="text-transform: uppercase"><?=$productBrand->title?></span></h1>
            <ul>
                <li><a href="<?=\yii\helpers\Url::home()?>">Главная</a></li>
                <li><a href="<?=\yii\helpers\Url::to(['product/'])?>">Продукты</a></li>
                <li><?=$productBrand->title?></li>
            </ul>
        </div>
    </div>
</section>
                ...
                <div class="woocommerce-widget-area">
                        ...
                        <form action="<?=\yii\helpers\Url::to(['product/filter'])?>" method="GET" class="filter_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="min">
                                        Min
                                        <input name="min" min="0" id="min" type="number" class="form-control">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="max">
                                        Max
                                        <input name="max" min="0" id="max" type="number" class="form-control">
                    ...
                    <div class="woocommerce-widget brands-list-widget">
                        ...
                        <?php if (!empty($allProductBrands)):?>
                            <ul class="brands-list-row">
                                <?php foreach ($allProductBrands as $allProductBrand):?>
                                    <li><a href="<?=\yii\helpers\Url::to(['product/by-brand', 'id' => $allProductBrand->id])?>"><?=$allProductBrand->title?></a></li>
                                <?php endforeach;?>
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <?php else:?>
                    ...
                    <div class="no_photo text-center">
                        <h1 class="text">
                            В категории <a href="" class="text-primary"><?=$productBrand->title?></a> пока нет товаров (
