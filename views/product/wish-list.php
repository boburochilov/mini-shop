...
if (!empty($_SESSION['wish']['product'])): ?>

    <?php $cart = $_SESSION['wish'] ;?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3>Мой Список Желаний  (<?=$cart['total_qty']?>)</h3>

                <div class="products-cart-content">

                    <?php foreach ($cart['product'] as $key => $product):?>

                        <div class="products-cart d-flex align-items-center wish_content">
                            ...
                            <div class="products-content wish_content">
                ...
                <div class="products-cart-btn">
                    <a href="<?=\yii\helpers\Url::to(['cart/checkout'])?>" class="default-btn">Посмотреть корзину</a>
                </div>
            </div>
        </div>
    </div>
...
<?php else: ?>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <img class="w-100 mb-2" src="/assets/img/empty-wishlist.jpg" alt="img">
            <h3 style="padding-bottom: 10px" class="text-danger text-center">Ваш список желаний пуст! :(</h3>
