...
<section class="page-title-area">
    <div class="container">
        <div class="page-title-content">
            <h1>Цвет продукта - <span style="background-color: <?=$productColor->title?>; padding: 15px; display: inline-block"> </span></h1>
            <ul>
                <li><a href="<?=\yii\helpers\Url::home()?>">Главная</a></li>
                <li><a href="<?=\yii\helpers\Url::to(['product/'])?>">Продукты</a></li>
               <li style="color: <?=$productColor->title?>">Цвет <span style="background-color: <?=$productColor->title?>; margin-bottom: -10px; padding: 15px; display: inline-block"> </span></li>
            </ul>
        </div>
    </div>
</section>
                        ...
                        <form action="<?=\yii\helpers\Url::to(['product/filter'])?>" method="GET" class="filter_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="min">
                                        Min
                                        <input min="0" name="min" id="min" type="number" class="form-control">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="max">
                                        Max
                                        <input min="0" name="max" id="max" type="number" class="form-control">
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <?php else:?>
                    ...
                    <div class="no_photo text-center">
                        <h1 class="text">
                            В Цвета <span style="background-color: <?=$productColor->title?>; padding: 15px; display: inline-block"> </span> пока нет товаров :(
