                        ...
                        <?php foreach ($filter as $item):?>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-products-box">
                                    <div class="image">
                                        <?php $image = \app\components\StaticFunctions::getImage('product',$item->id,$item->image)?>
                                        <a href="<?=\yii\helpers\Url::to(['product/view','id' => $item->id])?>" class="d-block">
                                            <?php if ($item->sale == 1): ?>
                                    ...
                                    <div class="content">
                                        <h3><a href="<?=\yii\helpers\Url::to(['product/view','id' => $item->id])?>"><?=$item->title?></a></h3>
                                        <div class="price">
...
//                                ]);
                ...
                <?php else:?>
                    ...
                    <div class="no_photo text-center">
                        <h1 class="text">
                            В Цвета <a href="" style="color:;"></a> пока нет товаров :(
